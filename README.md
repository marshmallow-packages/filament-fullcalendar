...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/marshmallow/filament-fullcalendar.svg?style=flat-square)](https://packagist.org/packages/marshmallow/filament-fullcalendar)
[![GitHub Tests Action Status](https://img.shields.io/github/workflow/status/marshmallow/filament-fullcalendar/run-tests?label=tests)](https://github.com/marshmallow/filament-fullcalendar/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://img.shields.io/github/workflow/status/marshmallow/filament-fullcalendar/Check%20&%20fix%20styling?label=code%20style)](https://github.com/marshmallow/filament-fullcalendar/actions?query=workflow%3A"Check+%26+fix+styling"+branch%3Amain)
[![Total Downloads](https://img.shields.io/packagist/dt/marshmallow/filament-fullcalendar.svg?style=flat-square)](https://packagist.org/packages/marshmallow/filament-fullcalendar)
...
use Marshmallow\FilamentFullCalendar\Widgets\FullCalendarWidget;
...
```css
@import '../../vendor/marshmallow/filament-fullcalendar/resources/css/filament-fullcalendar.css';
```
...
They're commented out by default so livewire does not spam requests without they being used. You are free to paste them in your `CalendarWidget` class. See: [FiresEvents](https://github.com/marshmallow-packages/filament-fullcalendar/blob/main/src/Widgets/Concerns/FiresEvents.php)

Since [v1.0.0](https://github.com/marshmallow-packages/filament-fullcalendar/releases/tag/v1.0.0) we use `onEventClick` to open the edit modal.
